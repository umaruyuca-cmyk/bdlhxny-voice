...
<section id="slr" class="proj-sec">
  ...
  <div class="point-grid">
    ...
    <div class="point"><h4>盯市补保与 AI 风险报告<span class="pt-tag">生产闭环 · Agent 原型</span></h4><p>Java 汇总 SKU 市价与在押货值,5% 阈值生成波动工单,人工审批 / 历史工单作废,待补金额纳入还款试算与资金拆分;另以 LangChain create_agent 实现 Agent 原型:3 个只读工具 + Pydantic 结构化输出。</p></div>
  </div>
...
<section id="sjjh" class="proj-sec">
  ...
  <p class="proj-lead">北京银行杭州分行生产小程序,负责小程序、H5、Vue 管理后台与 Java 服务端的全栈开发。</p>
  ...
  <div class="stat-row">
    ...
    <div class="stat"><b>安全治理</b><span>渗透整改 + 未登录接口审计</span></div>
  </div>
...
<section id="methodology" class="proj-sec">
  ...
  <table class="map-tbl">
    ...
    <tbody>
      <tr><td class="map-src"><b>盯市补保</b>:金额与业务状态由 Java 确定性计算,Agent 基于只读工具生成可追溯风险报告,不参与审批和资金操作</td><td class="map-arrow">→</td><td>治理层:权限与只读边界由代码强制执行,模型不可越权</td></tr>
