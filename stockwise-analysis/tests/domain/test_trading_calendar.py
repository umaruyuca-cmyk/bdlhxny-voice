...
from stockwise_analysis.domain.trading_calendar import AShareTradingCalendar
...
def test_heuristic_holiday_table_2026():
    ...
    from stockwise_analysis.domain.trading_calendar import _heuristic_is_trading_day
