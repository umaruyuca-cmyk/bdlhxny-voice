...
from stockwise_analysis.runtime.run_registry import RunLocation
...
logger = logging.getLogger("stockwise_analysis.api.routes")
...
def create_api_app(application: StockWiseApplication, api_prefix: str = "/api/v1") -> FastAPI:
    ...
    if application.chat_session_store is None:
        from stockwise_analysis.runtime.chat_sessions import create_chat_session_store
