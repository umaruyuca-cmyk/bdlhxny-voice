...
import com.stockwise.entity.KnowledgeChunk;
import com.stockwise.llm.EmbeddingService;
import com.stockwise.mapper.KnowledgeChunkMapper;
...
public class KnowledgeIngestService {
    ...
    public KnowledgeIngestService(EmbeddingService embeddingService,
                                  ...
                                  @Value("${stockwise.embedding.model:text-embedding-v4}") String embeddingModel) {
