...
public class ContextBudgetPolicy {
    ...
    public ContextBudgetPolicy(
            @Value("${stockwise.context-window.max-messages:10}") int maxMessages,
            @Value("${stockwise.context-window.local-max-memory-tokens:2000}") int localMaxMemoryTokens,
            @Value("${stockwise.context-window.paid-max-memory-tokens:4000}") int paidMaxMemoryTokens,
            @Value("${stockwise.context-window.max-message-tokens:800}") int maxMessageTokens,
            @Value("${stockwise.context-window.max-summaries:3}") int maxSummaries,
            @Value("${stockwise.context-window.max-summary-tokens:900}") int maxSummaryTokens) {
