...
--   -v checkpoint_password='...' \
--   -d bdlhRuntime -f db/platform/bootstrap/001_postgres_roles_and_schemas.sql
--
-- This script intentionally does not revoke permissions on public or move public
-- tables. Those actions are P2 cutover work and would break the current Python
-- Stores before their Java replacement is active.
...
REVOKE ALL ON SCHEMA checkpoint FROM PUBLIC;
